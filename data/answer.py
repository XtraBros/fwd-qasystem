...
file = "RES_5_questions.json" #change as required
...
correct_answers_list = [2,4,1,4,2,3,1,4,1,4,4,4,3,4,3,3,4,1,1,4,4,3,3,4,4,4,1,4,4,3]  # update based on questions.
